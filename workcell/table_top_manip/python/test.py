...
for i in range(2):
    ...
    print(f"[python] wrench before grasp: {wrench}")
    ...
    server.schedule_eoat_waypoints(eoat_cmds, timepoints_ms)
    pose_fb = server.get_pose(1)
    ...
    sleep(3)
    wrench = server.get_wrench(1)
    print(f"[python] wrench after grasp: {wrench}")
